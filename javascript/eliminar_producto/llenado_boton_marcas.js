...
const url_consulta_marca = "http://localhost/maxima_belleza/clases_php/consulta_marca_eliminacion.php";
  ...
  async Consulta(){
        ...
        for(let i = 0 ; i < numero_resultado; i ++){
          ...
          console.log(nombre_categoria);
              ...
              fetch("http://localhost/maxima_belleza/clases_php/consulta_productos_por_marca.php?marca='" + nombre_categoria + "'")
            .then(function(valor){
...
let objeto_consulta_marcas = new Consulta_marcas(".buscador_marcas_ul" , url_consulta_marca);
