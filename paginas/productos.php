...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="../css/productos_usuarios.css">
      ...
      <nav>
        ...
        <div class="menu_header">
          ...
          <ul class="menu_header__opciones">
            ...
            <li class ="menu_header__opciones_li"> <a href="#"> Nosotros </a>   </li>
            <li class ="menu_header__opciones_li"> <a href="#"> Contactos </a>  </li>

            <li class ="menu_header__opciones_li"> <a href="#"> Productos </a>  </li>
 ...
 <li><a href="#"> Productos </a> </li>
        ...
        <script src="../javascript/productos_usuarios/llenado_boton_categorias.js">

        </script>

                <script src="../javascript/productos_usuarios/consulta_inicial.js">

                </script>

                <script src="../javascript/productos_usuarios/consulta_boton_categorias.js">

                  </script>

                  <script src="../javascript/productos_usuarios/boton_marcas.js">

                  </script>
                  <script src="../javascript/productos_usuarios/llenado_boton_marcas.js">
